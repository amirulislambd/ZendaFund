  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[var(--surface)] px-4 py-16 sm:px-6 lg:px-8">
      <div className="w-full max-w-lg text-center">
        ...
        <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-orange-500/10 ring-4 ring-orange-500/20 sm:h-32 sm:w-32">
          <Ban className="h-12 w-12 text-orange-500 sm:h-16 sm:w-16" />
        </div>
        ...
        <p className="mt-4 text-base leading-relaxed text-[var(--muted)] sm:text-lg">
          You are authenticated, but you do not have permission to access this specific resource. 
