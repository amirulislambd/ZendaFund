    ...
    <>
      ...
      {isMobileOpen && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          />
          <div className="absolute inset-y-0 right-0 flex w-[min(18rem,85vw)] flex-col border-l border-(--border) bg-(--surface) p-4 text-(--foreground) shadow-2xl shadow-black/50 overflow-y-auto">
