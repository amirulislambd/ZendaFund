          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-5">
                ...
                <span className="ml-2 text-sm text-slate-400">Credits</span>
              </div>
              ...
              {/* Button */}
              <form action="/api/credit-checkout" method="POST">
                <input type="hidden" name="credits" value={pkg.credits} />

                <input type="hidden" name="priceUsd" value={pkg.priceUsd} />
      ...
      <section className="mt-20">
        ...
        >
          ...
          <p className="mt-6 max-w-2xl text-base leading-7 text-slate-400">
            Purchase credits securely and support verified campaigns instantly
            with fast delivery and transparent pricing.
          </p>
        </motion.div>
