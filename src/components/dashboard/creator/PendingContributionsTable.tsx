  ...
  <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
    ...
    <div>
      ...
      <p className="mt-3 max-w-2xl text-slate-300">
        Review pending contributions submitted to your campaigns and decide
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                <button className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-blue-500 px-3 py-2 text-sm font-medium text-blue-500 transition hover:bg-blue-500 hover:text-white">
                  <Eye size={16} />
                  View
                </button>
